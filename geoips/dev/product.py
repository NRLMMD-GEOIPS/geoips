...
def get_product(product_name, source_name, output_dict=None):
    ...
    See: geoips.dev.product.is_valid_product for full list of supported product dictionary formats
...
def list_products():
    ...
    from geoips.geoips_utils import list_product_specs_dict_yamls, list_product_source_dict_yamls
...
def get_covg_from_product(product_name, source_name, output_dict=None, covg_func_field_name=None):
    ''' Interface Under Development, please provide feedback to geoips@nrlmry.navy.mil
    ...
    if default_covg_func_field_name in products:
        return find_entry_point('coverage_checks', products[default_covg_func_field_name])
    return find_entry_point('coverage_checks', 'masked_arrays')


def get_covg_args_from_product(product_name, source_name, output_dict=None, covg_args_field_name=None):
    ''' Interface Under Development, please provide feedback to geoips@nrlmry.navy.mil

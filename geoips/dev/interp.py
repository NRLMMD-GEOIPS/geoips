...
def get_interp(interp_func_name):
    ...
    See: geoips.dev.interp.is_valid_interp for full list of supported interp function call signatures and return values
...
def list_interps_by_type():
    ...
    See geoips.dev.interp.is_valid_interp? for a list of available interpolation function types and associated call signatures / return values.
    See geoips.dev.interp.get_interp(interp_func_name) to retrieve the requested interpolation function
    See geoips.dev.interp.get_interp_type(interp_func_name) to retrieve the requested interpolation function type
...
def test_interp_interface():
    ''' Finds and opens every interp func available within the current geoips instantiation

    See geoips.dev.interp.is_valid_interp? for a list of available interp func types and associated call signatures / return values.
    See geoips.dev.interp.get_interp(interp_func_name) to retrieve the requested interp func

    Returns:
        (list) : List of all successfully opened geoips interp funcs
    '''

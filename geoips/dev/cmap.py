...
def get_cmap(cmap_func_name):
    ...
    See: geoips.dev.cmap.is_valid_cmap for full list of supported cmap function call signatures and return values
...
def list_cmaps_by_type():
    ...
    See geoips.dev.cmap.is_valid_cmap? for a list of available colormap function types and associated call signatures / return values.
    See geoips.dev.cmap.get_cmap(cmap_func_name) to retrieve the requested colormap function
    See geoips.dev.cmap.get_cmap_type(cmap_func_name) to retrieve the requested colormap function type
...
def test_cmap_interface():
    ''' Finds and opens every cmap func available within the current geoips instantiation

    See geoips.dev.cmap.is_valid_cmap? for a list of available cmap func types and associated call signatures / return values.
    See geoips.dev.cmap.get_cmap(cmap_func_name) to retrieve the requested cmap func

    Returns:
        (list) : List of all successfully opened geoips cmap funcs
    '''

...
def imagery_annotated(area_def,
    ...
    from geoips.image_utils.mpl_utils import plot_image, save_image, plot_overlays, create_colorbar
    ...
    try:
        ...
        LOG.warning('SKIPPING get_product: Invalid product specification %s / %s',
                    product_name, xarray_obj.source_name)
    if product_params and 'plot_coverage' in product_params:
        ...
        covg_func = get_covg_from_product(product_name, xarray_obj.source_name, output_dict)

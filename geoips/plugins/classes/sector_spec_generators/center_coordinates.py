...
class CenterCoordinateSectorSpecGeneratorPlugin(BaseSectorSpecGeneratorPlugin):
    ...
    def set_clat_clon_proj_info(
        self, clat, clon, pr_proj, num_samples, num_lines, pixel_width, pixel_height
    ):
    ...
    def call(
        ...
        proj4_dict, area_extent = self.set_clat_clon_proj_info(
            clat=clat,
            clon=clon,
            pr_proj=projection,
        ...
        # This is area_id= then name= for Python2, area_id= then description= for
        # Python3
...
PLUGIN_CLASS = CenterCoordinateSectorSpecGeneratorPlugin

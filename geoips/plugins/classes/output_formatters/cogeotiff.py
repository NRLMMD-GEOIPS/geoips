...
class CogeotiffOutputFormatterPlugin(BaseOutputFormatterPlugin):
    ...
    def get_rasterio_cmap_dict(
        self, mpl_cmap, scale_data_min=1, scale_data_max=255, missing_value=0
    ):
        """Get rasterio cmap dict, with vals between scale_data_min and scale_data_max."""  # NOQA
    ...
    def scale_geotiff_data(
        ...
        scales, offsets = self.get_scales_and_offsets(
    ...
    def get_geotiff_transform(self, area_def):
    ...
    def call(
        ...
        plot_data, missing_value, scales, offsets = self.scale_geotiff_data(
        ...
        with MemoryFile() as memfile:
            ...
            height, width, crs, src_transform = self.get_geotiff_transform(area_def)
            ...
            with memfile.open(**src_profile) as mem:
                ...
                if not is_rgba:
                    ...
                    cmap_dict = self.get_rasterio_cmap_dict(mpl_colors_info["cmap"])
...
PLUGIN_CLASS = CogeotiffOutputFormatterPlugin

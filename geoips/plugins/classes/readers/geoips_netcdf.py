...
class GeoipsNetcdfReaderPlugin(BaseReaderPlugin):
    """Geoips Netcdf reader plugin class."""
    ...
    def call(
        ...
        xarray_objs = {}
        for fname in fnames:
            xarray_objs[basename(fname)] = self.read_xarray_netcdf(fname)
...
PLUGIN_CLASS = GeoipsNetcdfReaderPlugin

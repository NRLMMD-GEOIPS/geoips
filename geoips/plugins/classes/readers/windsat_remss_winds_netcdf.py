...
class WindsatRemssWindsNetcdfReaderPlugin(BaseReaderPlugin):
    """Windsat Remss Winds Netcdf reader plugin class."""
...
PLUGIN_CLASS = WindsatRemssWindsNetcdfReaderPlugin

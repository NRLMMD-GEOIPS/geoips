...
Read a granule NASA GPM GMI TBs in h5 format (each granule file is about
...
class GmiHdf5ReaderPlugin(BaseReaderPlugin):
    """GMI Hdf5 reader plugin class."""
    ...
    def read_gmi_file(self, fname, xarray_gmi):
        ...
        # namelist_gmi  = ['latitude', 'longitude', 'V10', 'H10', 'V19','H19','V23',
        #                  'V37', 'H37', 'V89' ,'H89', 'V166', 'H166', 'V183-3',
        #                  'V183-7', 'time']
    ...
    def call(
        ...
        """
        # fname='data_gmi/20200518.203639.gpm.gmi.gpm_pps.x.gmi.TB2016.x.TB2016_1b_v05a.h5'  # NOQA
        ...
        for fname in fnames:
            ...
            xarray_gmi = self.read_gmi_file(fname, xarray_gmi)
...
PLUGIN_CLASS = GmiHdf5ReaderPlugin

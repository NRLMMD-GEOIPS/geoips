...
class WindsatIdr37BinaryReaderPlugin(BaseReaderPlugin):
    """Windsat Idr37 Binary reader plugin class."""
    ...
    # variables are needed in this for moving through the binary file correctly. There
    # is fmt: off and fmt: on comments, which prevent black from moving the # NOQA
    # comments.
    ...
    def call(
        ...
        for ii in range(rec_tot):  # loop records of this file
            ...
            try:
                ...
                # fmt: off
                # timeinfo = pd.datetime(2000, 1, 1, 12) + pd.Timedelta(jd2000, unit="s")  # NOQA
                # time_date = int(
...
PLUGIN_CLASS = WindsatIdr37BinaryReaderPlugin

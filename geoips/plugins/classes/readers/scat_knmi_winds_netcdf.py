...
class ScatKnmiWindsNetcdfReaderPlugin(BaseReaderPlugin):
    """Scat Knmi Winds Netcdf reader plugin class."""
    ...
    def read_knmi_data(self, wind_xarray):
        ...
        * attributes: source_name, platform_name, data_provider,
        ...
        wind_xarray["wind_speed_kts"] = wind_xarray["wind_speed"] * self.MS_TO_KTS
        ...
        for fname in fnames:
            try:
                ...
                if "scale_factor" in wind_xarray.time.attrs:
                    ...
                    # https://github.com/pydata/xarray/issues/8957#issuecomment-2103861806  # NOQA
            ...
            if (
                ...
                wind_xarray, geoips_metadata = self.read_knmi_data(wind_xarray)
...
PLUGIN_CLASS = ScatKnmiWindsNetcdfReaderPlugin

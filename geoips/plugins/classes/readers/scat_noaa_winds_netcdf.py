...
class ScatNoaaWindsNetcdfReaderPlugin(BaseReaderPlugin):
    """Scat Noaa Winds Netcdf reader plugin class."""
    ...
    def read_noaa_data(self, wind_xarray):
    ...
    def call(
        ...
        for fname in fnames:
            ...
            if hasattr(wind_xarray, "title") and "ASCAT" in wind_xarray.title:
                wind_xarray, geoips_metadata = self.read_noaa_data(wind_xarray)
...
PLUGIN_CLASS = ScatNoaaWindsNetcdfReaderPlugin

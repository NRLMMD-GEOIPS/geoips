...
class ViirsL2NetcdfReaderPlugin(BaseReaderPlugin):
    """Viirs L2 Netcdf reader plugin class."""
    ...
    def get_geoips_platform_name(self, meta_platform_name):
    ...
    def call(
        ...
        for gran_time, gran_files in self.pair_file_names(fnames).items():
            ...
            for fname in gran_files:
                ...
                gran_xobj = self.merge_xarrays(xr, gran_xobj)
            ...
            xobj = self.merge_xarrays(gran_xobj, xobj)
...
PLUGIN_CLASS = ViirsL2NetcdfReaderPlugin

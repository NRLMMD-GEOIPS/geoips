...
class VolcParserSectorMetadataGeneratorPlugin(BaseSectorMetadataGeneratorPlugin):
    """Volc Parser Sector Metadata generator plugin class."""
...
PLUGIN_CLASS = VolcParserSectorMetadataGeneratorPlugin

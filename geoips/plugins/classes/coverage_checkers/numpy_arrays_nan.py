...
class NumpyArraysNanCoverageCheckerPlugin(BaseCoverageCheckerPlugin):
    """Numpy Arrays NAN Coverage checker plugin class."""
...
PLUGIN_CLASS = NumpyArraysNanCoverageCheckerPlugin

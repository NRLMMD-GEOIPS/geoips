...
class CenterRadiusRgbaCoverageCheckerPlugin(BaseCoverageCheckerPlugin):
    """Center Radius Rgba Coverage checker plugin class."""
...
PLUGIN_CLASS = CenterRadiusRgbaCoverageCheckerPlugin

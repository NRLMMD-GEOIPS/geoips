...
class Pmw37HPhysicalColormapperPlugin(BaseColormapperPlugin):
    ...
    def call(self, data_range=[125, 310], cbar_label="TB (K)"):
...
PLUGIN_CLASS = Pmw37HPhysicalColormapperPlugin

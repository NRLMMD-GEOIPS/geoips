...
class MatplotlibLinearNormColormapperPlugin(BaseColormapperPlugin):
    """Matplotlib Linear Norm colormapper plugin class."""
...
PLUGIN_CLASS = MatplotlibLinearNormColormapperPlugin

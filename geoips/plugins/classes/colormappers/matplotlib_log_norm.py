...
class MatplotlibLogNormColormapperPlugin(BaseColormapperPlugin):
    """Matplotlib LOG Norm colormapper plugin class."""
...
PLUGIN_CLASS = MatplotlibLogNormColormapperPlugin

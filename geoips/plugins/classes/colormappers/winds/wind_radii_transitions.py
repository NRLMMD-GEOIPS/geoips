...
class WindRadiiTransitionColormapperPlugin(BaseColormapperPlugin):
    """Wind Radii Transition colormapper plugin class."""
...
PLUGIN_CLASS = WindRadiiTransitionColormapperPlugin

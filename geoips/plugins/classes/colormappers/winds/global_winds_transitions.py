...
class GlobalWindsTransitionColormapperPlugin(BaseColormapperPlugin):
    """Global Winds Transition colormapper plugin class."""
...
PLUGIN_CLASS = GlobalWindsTransitionColormapperPlugin

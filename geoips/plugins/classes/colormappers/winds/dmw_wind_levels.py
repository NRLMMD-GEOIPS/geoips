...
class DmwWindLevelColormapperPlugin(BaseColormapperPlugin):
    """DMW Wind Level colormapper plugin class."""

    interface = "colormappers"
    family = "matplotlib"
    name = "dmw_wind_levels"

    def call(self, data_range=[0, 3], pressure_range_legend=None):
        ...
        pressure_range_legend : list, optional
            List of strings that are used for setting the cbar tick labels, by default
            None
...
PLUGIN_CLASS = DmwWindLevelColormapperPlugin

...
class GeoipsNetcdfFnameFilenameFormatterPlugin(BaseFilenameFormatterPlugin):
    """Geoips Netcdf Fname Filename formatter plugin class."""
    ...
    def call(
        ...
        if xarray_obj.area_definition:
            ...
            area_id = "x"
        ncdf_fname = self.assemble_geoips_netcdf_fname(
            basedir=basedir,
...
PLUGIN_CLASS = GeoipsNetcdfFnameFilenameFormatterPlugin

...
class BasicFnameFilenameFormatterPlugin(BaseFilenameFormatterPlugin):
    """Basic Fname Filename formatter plugin class."""
...
PLUGIN_CLASS = BasicFnameFilenameFormatterPlugin

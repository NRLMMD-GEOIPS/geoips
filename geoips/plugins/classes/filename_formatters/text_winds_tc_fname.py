...
class TextWindsTcFnameFilenameFormatterPlugin(BaseFilenameFormatterPlugin):
    """Text Winds TC Fname Filename formatter plugin class."""
    ...
    def call(
        self, xarray_obj, extension=".txt", basedir=gpaths["TCWWW"], output_dict=None
    ):
        ...
        return self.assemble_windspeeds_text_tc_fname(
            basedir=basedir,
...
PLUGIN_CLASS = TextWindsTcFnameFilenameFormatterPlugin

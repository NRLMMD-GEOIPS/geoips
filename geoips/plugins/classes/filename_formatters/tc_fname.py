...
class TcFnameFilenameFormatterPlugin(BaseFilenameFormatterPlugin):
    """TC Fname Filename formatter plugin class."""
    ...
    def call(
        ...
        # This allows you to explicitly set matplotlib parameters (colorbars, titles,
        # etc).
        ...
        web_fname = self.assemble_tc_fname(
            basedir=basedir,
    ...
    def tc_fname_remove_duplicates(self, fname, mins_to_remove=3, remove_files=False):
        ...
        if (ext1 == ".png") or (ext1 == ".yaml" and ext2 == ".png"):
            ...
            LOG.info(
                "NOT REMOVING DUPLICATES. Not tc_web filename, not png or png.yaml."
            )
            return [], []
...
PLUGIN_CLASS = TcFnameFilenameFormatterPlugin

...
class GeoipsFnameFilenameFormatterPlugin(BaseFilenameFormatterPlugin):
    """Geoips Fname Filename formatter plugin class."""
    ...
    def call(
        ...
        if extra:
            ...
            extra = base_extra
        web_fname = self.assemble_geoips_fname(
            basedir=basedir,
    ...
    def geoips_fname_remove_duplicates(
        self, fname, mins_to_remove=10, remove_files=False
    ):
...
PLUGIN_CLASS = GeoipsFnameFilenameFormatterPlugin

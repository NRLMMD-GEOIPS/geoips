...
class TcStandardTitleFormatterPlugin(BaseTitleFormatterPlugin):
    """TC Standard Title formatter plugin class."""
...
PLUGIN_CLASS = TcStandardTitleFormatterPlugin

...
class StaticStandardTitleFormatterPlugin(BaseTitleFormatterPlugin):
    """Static Standard Title formatter plugin class."""
...
PLUGIN_CLASS = StaticStandardTitleFormatterPlugin

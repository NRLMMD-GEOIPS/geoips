...
class DifferenceValidatorPlugin(BaseValidatorPlugin):
    """Difference validator plugin.

    This is a dummy plugin and not intended to be used. Created as an example for
    future validator plugins to be created.
    """
...
PLUGIN_CLASS = DifferenceValidatorPlugin

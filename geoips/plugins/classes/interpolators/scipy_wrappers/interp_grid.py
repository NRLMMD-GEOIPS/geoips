...
from geoips.plugins.classes.interpolators.utils.interp_scipy import interp_griddata

LOG = logging.getLogger(__name__)


class InterpGridInterpolatorPlugin(BaseInterpolatorPlugin):
    """Interp Grid interpolator plugin class."""
...
PLUGIN_CLASS = InterpGridInterpolatorPlugin

...
class ModelChannelAlgorithmPlugin(BaseAlgorithmPlugin):
    """Model Channel algorithm plugin class."""
    ...
    def call(
        ...
        xarray.Dataset
            ...
            holds appropriately scaled data as a ``numpy.ndarray`` or
            ``numpy.MaskedArray``.
        """
        invar = variables[0]
...
PLUGIN_CLASS = ModelChannelAlgorithmPlugin

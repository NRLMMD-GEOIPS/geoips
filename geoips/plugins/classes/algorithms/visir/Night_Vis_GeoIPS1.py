...
class NightVisGeoips1AlgorithmPlugin(BaseAlgorithmPlugin):
    """Night VIS Geoips1 algorithm plugin class."""
    ...
    def call(
        self, arrays, min_outbounds="crop", max_outbounds="crop", max_night_zen=90
    ):
...
PLUGIN_CLASS = NightVisGeoips1AlgorithmPlugin

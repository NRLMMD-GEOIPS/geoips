...
class NightVisIrGeoips1AlgorithmPlugin(BaseAlgorithmPlugin):
    """Night VIS IR Geoips1 algorithm plugin class."""

    interface = "algorithms"
    family = "list_numpy_to_numpy"
    name = "Night_Vis_IR_GeoIPS1"

    def call(self, arrays, max_night_zen=90):
...
PLUGIN_CLASS = NightVisIrGeoips1AlgorithmPlugin

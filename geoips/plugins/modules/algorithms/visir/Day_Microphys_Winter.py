...
class DayMicrophysWinterAlgorithmPlugin(BaseAlgorithmPlugin):
    """Day Microphys Winter algorithm plugin class."""
...
PLUGIN_CLASS = DayMicrophysWinterAlgorithmPlugin

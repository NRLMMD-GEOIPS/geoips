...
class AbsdiffMstAlgorithmPlugin(BaseAlgorithmPlugin):
    """Absdiff MST algorithm plugin class."""
    ...
    def call(
        ...
        product_name : str
            * String representing the product produced by this algorithm, using
              variables from 'xobj'
        ...
        # Otherwise get variable 1 from timestep 1 and variable 2 from timestep 2
            ...
            raise PluginError(
                "Error: more than 2 variables were provided to absdiff_mst algorithm "
                f"plugin .\n Variables = {variables}. Cannot take the absolute "
                "difference between more than two variables from two different time "
                "steps. Please provide only 1-2 variable names for product: "
                f"{product_name}."
            )
...
PLUGIN_CLASS = AbsdiffMstAlgorithmPlugin

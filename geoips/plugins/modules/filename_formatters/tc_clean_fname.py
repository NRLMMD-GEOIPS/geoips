...
class TcCleanFnameFilenameFormatterPlugin(BaseFilenameFormatterPlugin):
    """TC Clean Fname Filename formatter plugin class."""
...
PLUGIN_CLASS = TcCleanFnameFilenameFormatterPlugin

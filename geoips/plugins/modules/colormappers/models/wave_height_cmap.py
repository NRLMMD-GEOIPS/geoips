...
class WaveHeightCmapColormapperPlugin(BaseColormapperPlugin):
    """Wave Height Cmap colormapper plugin class."""

    interface = "colormappers"
    family = "matplotlib"
    name = "wave_height_cmap"

    def call(self, data_range=[0, 8]):
...
PLUGIN_CLASS = WaveHeightCmapColormapperPlugin

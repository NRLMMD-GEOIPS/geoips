...
class WindRadiiTransitionsLegacyColormapperPlugin(BaseColormapperPlugin):
    """Wind Radii Transitions Legacy colormapper plugin class."""

    interface = "colormappers"
    family = "matplotlib"
    name = "wind_radii_transitions_legacy"

    def call(self, data_range=[0, 200]):
...
PLUGIN_CLASS = WindRadiiTransitionsLegacyColormapperPlugin

...
class Pmw89HLegacyColormapperPlugin(BaseColormapperPlugin):
    ...
    def call(self, data_range=[180.0, 280.0], cbar_label="TB (K)"):
...
PLUGIN_CLASS = Pmw89HLegacyColormapperPlugin

...
class Pmw89HPhysicalColormapperPlugin(BaseColormapperPlugin):
    ...
    def call(self, data_range=[105, 305], cbar_label="TB (K)"):
...
PLUGIN_CLASS = Pmw89HPhysicalColormapperPlugin

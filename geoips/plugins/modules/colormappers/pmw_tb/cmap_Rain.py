...
class PmwRainColormapperPlugin(BaseColormapperPlugin):
    ...
    def call(self, data_range=[0.05, 50.0], cbar_label=r"Rainrate $(mm hr^{-1})$"):
...
PLUGIN_CLASS = PmwRainColormapperPlugin

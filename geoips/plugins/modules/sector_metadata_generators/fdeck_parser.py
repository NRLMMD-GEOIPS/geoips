...
class FdeckParserSectorMetadataGeneratorPlugin(BaseSectorMetadataGeneratorPlugin):
    ...
    def call(self, trackfile_name, allowed_aid_types=None):
        ...
        entry_storm_start_datetime = self.get_storm_start_datetime_from_fdeck_entry(
            flatsf_lines
        )
        ...
        # filename_storm_start_datetime = get_storm_start_datetime_from_fdeck_filename(
        # #TLO
        #    trackfile_name  #TLO
        # )  #TLO
        ...
        LOG.info(
            "  USING storm_start_datetime from fdeck %s", entry_storm_start_datetime
        )
        LOG.info(
        ...
        for line in flatsf_lines:
            curr_fields = self.parse_fdeck_line(
                line,
    ...
    def parse_fdeck_line(
        ...
        # len(parts) != 42:
        #    raise ValueError(
        #        "Incorrectly formatted deck file - must have either 30 or 38 or 42 "
        #        "fields"
        #    )
        fields = {}
    ...
    def get_final_storm_name_fdeck(self, deck_lines, tcyear):
        ...
        for line in deck_lines:
            ...
            curr_fields = self.parse_fdeck_line(line, tcyear, final_storm_name)
...
PLUGIN_CLASS = FdeckParserSectorMetadataGeneratorPlugin

...
<<<<<<<< HEAD:geoips/plugins/modules/interpolators/pyresample_wrappers/interp_nearest.py
...
>>>>>>>> integration:geoips/plugins/modules/interpolation/pyresample_wrappers/interp_nearest.py
    interp_kd_tree,

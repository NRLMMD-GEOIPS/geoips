...
def get_latitude_longitude(metadata, BADVALS, sect=None):
    ...
    This routine accepts a dictionary containing metadata as read from a NetCDF4
...
def _get_geolocation_metadata(metadata):
    ...
    This is split out so we can easily create a chache of the data for creation

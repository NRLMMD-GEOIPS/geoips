...
class FilenameFormatterArgumentsModel(PermissiveFrozenModel):
    ...
    # 
    coverage: float = Field(None, description="Image coverage, float between 0.0 and 100.0")
    output_type: str = Field(None, )
    # What does default to output_type means here
    output_type_dir: DirectoryPath = Field(None, description="If None, default to output_type.")

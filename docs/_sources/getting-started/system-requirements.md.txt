...
|----------|-------------|-------------|--------------------------------------|
| CPU      | 2 CPU       | 4 CPU       |                                      |
| Memory   | 12GB        | 128GB       | RAM Requirements vary widely based on the imagery you are working with. |
| Storage  | 20GB on SSD | 20GB on SSD | Plus additional storage, as needed, for datasets. |

...
* Added plugins for 3D georing data
* Bug fixes
...
Add Plugins for 3D GEOring data
-------------------------------

*From NRLMMD-GEOIPS/geoips#253: 2023-08-09, Create GEOring_3D reader for GeoIPS

GeoIPS previously was unable to process 3D data due to the limitations in run_procflow.
This branch was merged with 315-make-sectoring-optional, so that the data wouldn't be
sectored before the algorithm was applied. Eventually we'd like to implement this data
via an order-based procflow, but this works for now. A reader, algorithm,
title_formatter, colormappers, and products/product_defaults were created for this data.
...
::
    ...
    added: geoips/geoips/plugins/modules/algorithms/georing_3d.py
    added: geoips/geoips/plugins/modules/readers/georing_3d_netcdf.py
    added: geoips/geoips/plugins/modules/title_formatters/georing_3d_cloud_type.py
    added: geoips/geoips/plugins/modules/colormappers/cloud_type.py
    added: geoips/geoips/plugins/modules/colormappers/cmap_cldHeight.py
    added: geoips/geoips/plugins/yaml/products/georing_3d.yaml
    added: geoips/geoips/plugins/yaml/product_defaults/georing_3d/Binary_Cloud_Mask.yaml
    added: geoips/geoips/plugins/yaml/product_defaults/georing_3d/Cloud_Base_Height.yaml
    added: geoips/geoips/plugins/yaml/product_defaults/georing_3d/Cloud_Top_Height.yaml
    added: geoips/geoips/plugins/yaml/product_defaults/georing_3d/Cloud_Type.yaml
    added: geoips/tests/scripts/test_georing_data.sh

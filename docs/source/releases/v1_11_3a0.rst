...
* Add 'no_sectoring' procflow flag to disable singe_source sectoring
* Bug fixes
...
The previous implementation of single_source sectoring always sectors data, whether
...
single_source sectoring no longer occurs.

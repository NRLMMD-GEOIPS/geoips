...
GeoIPS uses reStructuredText (RST) for documentation. Doc8 helps us enforce 
standards for how those RST files are formatted. This adds a check
to all pull requests to make sure new additions meet the standards.

...
The :ref:`Complete Local conda-based GeoIPS Installation<installation>`
...
**Use the** :ref:`Complete Local conda-based GeoIPS Installation<installation>`
**for the fully supported installation, which includes all
dependencies**

Required (**included in**
:ref:`Complete Local conda-based GeoIPS Installation<installation>`)

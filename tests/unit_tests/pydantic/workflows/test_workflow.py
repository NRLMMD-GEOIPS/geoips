...
test_cases = load_test_cases("./test_pydantic_workflow_cases.yaml")
...
def test_good_plugin(good_plugin):
    ...
    """
    validate_good_plugin(good_plugin, WorkflowPluginModel)
...
def test_bad_plugins(good_plugin, test_tup):
    ...
    """
    validate_bad_plugin(good_plugin, test_tup, WorkflowPluginModel)
...
def pluign_types_and_plugins():
    ...
    return {
        "reader":
        [
            "scat_knmi_winds_netcdf", "abi_netcdf", "mimic_netcdf", "geoips_netcdf",
            "seviri_hrit", "amsub_mirs", "atms_hdf5", "amsr2_remss_winds_netcdf",
            "modis_hdf4", "wfabba_ascii", "saphir_hdf5", "ssmis_binary",
            "ewsg_netcdf", "viirs_sdr_hdf5", "amsr2_netcdf", "amsub_hdf",
            "gmi_hdf5", "viirs_netcdf", "windsat_remss_winds_netcdf",
            "scat_noaa_winds_netcdf", "windsat_idr37_binary", "smos_winds_netcdf",
            "imerg_hdf5", "ahi_hsd", "ascat_uhr_netcdf", "sar_winds_netcdf",
            "ami_netcdf", "ssmi_binary", "cygnss_netcdf", "abi_l2_netcdf",
            "sfc_winds_text", "smap_remss_winds_netcdf", "clavrx_netcdf4",
            "clavrx_hdf4",
        ],
    }

...
geoips run config_based \
  $GEOIPS_TESTDATA_DIR/test_data_abi/data/goes16_20210929_0000/OR_ABI-L2-DMWF*C{07,10,14}*.nc \
  --output_config ${GEOIPS_PACKAGES_DIR}/geoips/tests/yaml_configs/abi_dmw_overlay.yaml \
  --fuse_files ${GEOIPS_TESTDATA_DIR}/test_data_abi/data/goes16_20210929_0000/*L1b-RadF* \

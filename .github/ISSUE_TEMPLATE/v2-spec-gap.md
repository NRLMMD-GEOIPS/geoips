---
name: Conformance gap (v2.0.0 specification)
about: Record a confirmed difference between a v2.0.0 specification requirement and the current implementation
title: "[gap] "
labels: v2-spec-gap, plugin-specs, v2.0
---
...
<!-- Interface, family, or base-class contract affected. -->
...
<!-- Source locations, tests, runtime output, prior issues, or design records. -->

## Impact

<!-- Consequence of shipping v2.0.0 with this gap unresolved. -->
